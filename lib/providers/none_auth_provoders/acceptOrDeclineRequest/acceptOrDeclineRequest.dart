...
class AcceptOrDeclineRequestProvider extends BaseProvider {
  ...
  void respond(BuildContext context) async {
    try {
      if (_status == null ||
          _comment == null) {
        ...
        print("Muslim acceptOrDecline Response is $acceptOrDecline");
        ForwardNavigation.withReturn(context, HomeIndex());
        Alerts.successAlert(context, "Successfully sent response", (){ForwardNavigation.withNoReturn(context, HomeIndex());});
