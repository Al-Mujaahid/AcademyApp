...
class EmailUsernamePhone extends StatelessWidget {
  ...
  const EmailUsernamePhone({Key? key}) : super(key: key);
  static String? init_nikcname;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: SafeArea(
        child: Consumer<OtherPersonalInfoProvider>(
                        ...
                        InkWell(
                            ...
                            child: Container(
                              ...
                              child: SideSpace(
                                  5,
                                  5,
                                  TextOf('Save changes', 15, FontWeight.w600,
                                      green)),
                            ))
                      ],
                    ),
                      ...
                      child: Column(
                        children: [
                            ...
                            child: SideSpace(
                                ...
                                TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                      hintText:
                                          EmailUsernamePhone.init_nikcname,
                                      border: OutlineInputBorder(
                                          borderRadius:
                                              BorderRadius.circular(10),
                                          borderSide: BorderSide(color: ash2))),
                                )),
                          ),
                          YSpace(10),
                          Row(
                            children: [
                              TextOf(
                                  'Phone number', 20, FontWeight.w400, black),
                            ],
                          ),
                          Container(
                            width: double.infinity,
                            child: SideSpace(
                                ...
                                TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                      hintText: EmailUsernamePhone.init_phone,
                                      border: OutlineInputBorder(
                                          borderRadius:
                                              BorderRadius.circular(10),
                                          borderSide: BorderSide(color: ash2))),
                          ...
                          Container(
                            ...
                            child: SideSpace(
                                ...
                                TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                      hintText: EmailUsernamePhone.init_school,
                                      border: OutlineInputBorder(
                                          borderRadius:
                                              BorderRadius.circular(10),
                                          borderSide: BorderSide(color: ash2))),
                          ...
                          Container(
                            ...
                            child: SideSpace(
                                ...
                                TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                      hintText: EmailUsernamePhone.init_classs,
                                      border: OutlineInputBorder(
                                          borderRadius:
                                              BorderRadius.circular(10),
                                          borderSide: BorderSide(color: ash2))),
                          ...
                          Container(
                            ...
                            child: SideSpace(
                                ...
                                TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                      hintText: EmailUsernamePhone
                                          .init_course_of_stydy,
                                      border: OutlineInputBorder(
                                          borderRadius:
                                              BorderRadius.circular(10),
                                          borderSide: BorderSide(color: ash2))),
                          ...
                          Container(
                            ...
                            child: SideSpace(
                                ...
                                TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                      hintText:
                                          EmailUsernamePhone.init_qualification,
                                      border: OutlineInputBorder(
                                          borderRadius:
                                              BorderRadius.circular(10),
                                          borderSide: BorderSide(color: ash2))),
                          ...
                          Container(
                            ...
                            child: SideSpace(
                                ...
                                TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                      hintText: EmailUsernamePhone.init_branch,
                                      border: OutlineInputBorder(
                                          borderRadius:
                                              BorderRadius.circular(10),
                                          borderSide: BorderSide(color: ash2))),
                          ...
                          Row(
                            children: [
                              TextOf(
                                  'Social media', 20, FontWeight.w400, black),
                            ],
                          ),
                          Container(
                            width: double.infinity,
                            child: SideSpace(
                                ...
                                TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                      hintText:
                                          EmailUsernamePhone.init_social_media,
                                      border: OutlineInputBorder(
                                          borderRadius:
                                              BorderRadius.circular(10),
                                          borderSide: BorderSide(color: ash2))),
                          ...
                          Container(
                            ...
                            child: SideSpace(
                                ...
                                TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                      hintText: EmailUsernamePhone.init_skills,
                                      border: OutlineInputBorder(
                                          borderRadius:
                                              BorderRadius.circular(10),
                                          borderSide: BorderSide(color: ash2))),
                          ...
                          Container(
                            ...
                            child: SideSpace(
                                ...
                                TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                      hintText: EmailUsernamePhone.init_post,
                                      border: OutlineInputBorder(
                                          borderRadius:
                                              BorderRadius.circular(10),
                                          borderSide: BorderSide(color: ash2))),
                          ...
                          Container(
                            ...
                            child: SideSpace(
                                ...
                                TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                      hintText: EmailUsernamePhone.init_address,
                                      border: OutlineInputBorder(
                                          borderRadius:
                                              BorderRadius.circular(10),
                                          borderSide: BorderSide(color: ash2))),
                          ...
                          Container(
                            ...
                            child: SideSpace(
                                ...
                                TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                      hintText: EmailUsernamePhone.init_sex,
                                      border: OutlineInputBorder(
                                          borderRadius:
                                              BorderRadius.circular(10),
                                          borderSide: BorderSide(color: ash2))),
