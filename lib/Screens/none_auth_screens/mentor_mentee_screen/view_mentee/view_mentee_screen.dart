...
class ViewMenteeScreen extends StatefulWidget {
  const ViewMenteeScreen({Key? key, required this.mentee}) : super(key: key);
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                YSpace(16),
                Text("${widget.mentee.firstName} ${widget.mentee.lastName}", style: TextStyle(
          ...
          Expanded(
            child: ChangeNotifierProvider(
              create: (context) => GetScheduleProvider(
                mentorId: Provider.of<UserProfileProvider>(context, listen: false).userData.user_id.toString(),
                menteeId: widget.mentee.id!.toString()
              ),
                ...
                builder: (context, value, child) {
                  ...
                  if (value.scheduleList.isEmpty) {
                    return Center(
                      child: InkWell(
                        onTap: () => value.getSchedule(),
                        child: Text("You do not have any schedule with ${widget.mentee.firstName}, click to refresh", style: TextStyle(
        ...
        child: Center(
          child: ElevatedButton(
            ...
            onPressed: () async {
              ...
              // print("MenteeId: ${widget.mentee.id}");
