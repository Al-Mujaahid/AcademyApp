...
class UserProfile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SafeArea(child: Container(child: Consumer<UserProfileProvider>(
        builder: (context, value, child) {
          ...
          if (!value.loading) {
            ...
            UpdateUserProfile.init_availability_status =
                userD.availability_status;
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          Row(
                            children: [
                              TextOf(userD.first_name!, 23, FontWeight.w900,
                                  black),
                              XSpace(5),
                              TextOf(
                                  userD.last_name!, 23, FontWeight.w900, black)
                            ],
                          ),
                          TextOf(
                              userD.social_media!, 17, FontWeight.w400, ash2),
                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          child: SideSpace(
                              ...
                              5,
                              TextOf(
                                  'Edit Profile', 15, FontWeight.bold, black)),
                        ),
                      )
                    ],
                  ),
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: SideSpace(
                                10,
                                10,
                                TextOf(userD.nick_name!, 19, FontWeight.w500,
                                    black)),
                          ),
                          YSpace(7),
                          Row(
                          ...
                          Container(
                            ...
                            child: SideSpace(
                                10,
                                10,
                                TextOf(userD.phone_number!, 19, FontWeight.w500,
                                    black)),
                          ),
                          YSpace(7),
                          Row(
                          ...
                          Container(
                            ...
                            child: SideSpace(
                                ...
                                10,
                                TextOf(
                                    userD.school!, 19, FontWeight.w500, black)),
                          ),
                          YSpace(7),
                          Row(
                            children: [
                              TextOf(
                                  'Home Address', 20, FontWeight.w400, black),
                            ],
                          ),
                          Container(
                            width: double.infinity,
                            ...
                            child: SideSpace(
                                10,
                                10,
                                TextOf(userD.address!, 19, FontWeight.w500,
                                    black)),
                          ),
                          YSpace(7),
                          Row(
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                border: Border.all(color: ash2),
                                borderRadius: BorderRadius.circular(10)),
                            child: SideSpace(10, 10,
                                TextOf(userD.sex!, 19, FontWeight.w500, black)),
                          ),
                          YSpace(7),
                          Row(
                            children: [
                          ...
                          Container(
                            ...
                            child: SideSpace(
                                ...
                                10,
                                TextOf(
                                    userD.classs!, 19, FontWeight.w500, black)),
                          ),
                          YSpace(7),
                          Row(
                            children: [
                              TextOf('Course of study', 20, FontWeight.w400,
                                  black),
                            ],
                          ),
                          Container(
                            ...
                            child: SideSpace(
                                10,
                                10,
                                TextOf(userD.course_of_stydy!, 19,
                          ...
                          Row(
                            children: [
                              TextOf(
                                  'Qualification', 20, FontWeight.w400, black),
                            ],
                          ),
                          Container(
                            width: double.infinity,
                            ...
                            child: SideSpace(
                                10,
                                10,
                                TextOf(userD.qualification!, 19,
                                    FontWeight.w500, black)),
                          ),
                          YSpace(7),
                          Row(
                            children: [
                              TextOf('Number of children', 20, FontWeight.w400,
                                  black),
                            ],
                          ),
                          Container(
                            ...
                            child: SideSpace(
                                10,
                                10,
                                TextOf(userD.no_of_children.toString(), 19,
                                    FontWeight.w500, black)),
                          ),
                          YSpace(7),
                          Row(
                          ...
                          Container(
                            ...
                            child: SideSpace(
                                ...
                                10,
                                TextOf(
                                    userD.skills!, 19, FontWeight.w500, black)),
                          ),
                          YSpace(7),
                          Row(
                            children: [
                              TextOf('Availability status', 20, FontWeight.w400,
                                  black),
                            ],
                          ),
                          Container(
                            ...
                            child: SideSpace(
                                10,
                                10,
                                TextOf(userD.availability_status!, 19,
                                    FontWeight.w500, black)),
                          ),
                          YSpace(7),
                          Row(
                            children: [
                              TextOf(
                                  'Marital status', 20, FontWeight.w400, black),
                            ],
                          ),
                          Container(
                            width: double.infinity,
                            ...
                            child: SideSpace(
                                10,
                                10,
                                TextOf(userD.marital_status!, 19,
                                    FontWeight.w500, black)),
                          ),
                          YSpace(7),
                          Row(
                          ...
                          Container(
                            ...
                            child: SideSpace(
                                ...
                                10,
                                TextOf(
                                    userD.post!, 19, FontWeight.w500, black)),
                          ),
                        ],
                      ),
                    ),
