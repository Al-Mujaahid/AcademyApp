class PendingMentorRequest {
  ...
  PendingMentorRequest.fromJson(Map<String, dynamic> json)
      : id = json['id'],
...
class PendingMenteeRequest {
  ...
  PendingMenteeRequest.fromJson(Map<String, dynamic> json)
      : id = json['id'],
